class Checkers {
  ...
  //Initialization and Rendering - Methods related to setting up the game board.
  renderBoard() {
  ...
  //Event Handling - Methods associated with event listeners and related responses
  mouseHover() {
    const squares = document.querySelectorAll("#board .square");
  ...
  //Move Logic - Methods that handle the logic behind moving pieces
  ...
  //Gameplay Utilities - methods that update the UI
  checkKing() {
    if (this.selectedPeice.classList.contains("player2")) {
